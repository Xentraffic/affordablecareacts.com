$(document).ready(function () {
    ...
    var currentStep;
    var makeOver50k = "";
    var fbPixelCodeStep1 = false;
    var fbPixelCodeStep2 = false;
    var fbPixelCodeStep3 = false;
    var fbPixelCodeStep4 = false;
    ...
    $('button.chat-button').on('click', function () {
        ...
        if (currentStep == 1) {
            ...
            if (buttonValue == 'Yes') {
                console.log('I am here Step 1 Yes');
                fbPixelCodeStep1 = true;
            } 
        }
        ...
        if (currentStep == 2) {
            ...
            if (buttonValue == 'Yes') {
                console.log('I am here Step 2 Yes');
                fbPixelCodeStep2 = true;
            } 

            // console.log(fbPixelCodeStep2);
        ...
        if (currentStep == 3) {
            ...
            if (buttonValue == 'No') {
                if (makeOver60k == "Yes") {
                    $("#PrimaryNumber").attr('href', 'tel:8557341379');
                    $("#PrimaryNumber").text('(855)-734-1379');
                    $("#DownsellNumber").attr('href', 'tel:8557341379');
                    $("#DownsellNumber").text('(855)-734-1379');
                ...
                if (buttonValue == 'No') {
                    console.log('I am here Step 3 No');
                    fbPixelCodeStep3 = true;
                } 
        
                // console.log(fbPixelCodeStep3);
            } else if (buttonValue == 'Medicaid') {
                if (makeOver50k == "Yes") {

                    $("#PrimaryNumber").attr('href', 'https://nationalcareoptions.com/lp/xen-medicare');
                    $("#PrimaryNumber").text('click here');
                    $("#DownsellNumber").attr('href', 'https://nationalcareoptions.com/lp/xen-medicare');
                ...
                if (makeOver50k == "Yes") {
                    ...
                    $("#PrimaryNumber").attr('href', 'https://nationalcareoptions.com/lp/xen-aca');
                    $("#PrimaryNumber").text('click here');
                    $("#DownsellNumber").attr('href', 'https://nationalcareoptions.com/lp/xen-aca');
                    $("#DownsellNumber").text('click here');
            ...
            console.log(fbPixelCodeStep1);
            console.log(fbPixelCodeStep2);
            console.log(fbPixelCodeStep3);

            if(fbPixelCodeStep1==true && fbPixelCodeStep2==true && fbPixelCodeStep3==true ){

                document.getElementById("msg17").onclick = function () {
                    fbq("track", "Purchase");
                };
            }
