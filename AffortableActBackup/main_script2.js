const healtLink = [
    "https://selectmypolicy.com/health",
    "https://www.cobrainsurancenetwork.com/vcobra8/step1.html",
    "https://biden.healthplans.org",
    "https://healthcarepronto.com/"
]
$(document).ready(function () {
    ...
    $(".q1-btn-bis").on("click", function () {
        window.location.href = "https://intedure-virsoles.com/01dfeeab-b3fb-4bad-ba5a-4ed67f7f5f05?display={display}&source={source}&lastname={lastname}&email={email}&gender={gender}&phone={phone}&dob={dob}&creative={creative}&clickId={clickId}" //healtLink[Math.floor(Math.random() * 3)]
